          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                leaders shaping the future of the security and facility industry
                with innovation, discipline, and service excellence.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                ...
                comprehensive certifications reflecting our professionalism and
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-900 mb-8 leading-relaxed">
                ...
                specialized practical training before deployment, ensuring 100%
