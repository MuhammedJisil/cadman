...
const AboutUs = () => {
  ...
  return (
    <>
      <SEO
        title="About Cadman – Trusted Security & Facility Management Company"
        description="Cadman is a professional security and facility management company delivering reliable manpower, housekeeping, industrial workforce, and protection services for businesses and residential communities."
      />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  ...
                  security and facility industry with innovation, discipline,
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Three dynamic leaders driving innovation, discipline, and
                service excellence across the industry
              </p>
            </div>
            ...
            <div className="mt-16 bg-amber-50 p-8 border-l-4 border-amber-500">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  from statutory risks and penalties, giving them peace of mind
