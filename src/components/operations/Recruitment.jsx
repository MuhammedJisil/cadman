...
const Recruitment = () => {
  ...
  return (
    <>
      <SEO
        title="Cadman Recruitment Process – Skilled Manpower Hiring"
        description="Learn about Cadman's recruitment process for security personnel, housekeeping staff, and industrial workforce. We ensure a thorough selection and training process to deliver skilled and reliable manpower solutions."
      />
          ...
          <div className="relative max-w-7xl mx-auto px-6 pt-48 pb-32 lg:pt-56 lg:pb-40 md:pt-44 md:pb-24">
            <div className="max-w-3xl">
              ...
              >
                ...
                the highest standards of discipline, professionalism, and
                service excellence.
              </p>
            </div>
          </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Every candidate undergoes a rigorous evaluation process to
                ensure we deploy only the best qualified and trained personnel
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  ...
                  monitoring systems, and professional conduct to ensure
                  complete readiness.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-300 mb-8 leading-relaxed">
                  ...
                  verification of all credentials before deployment. No
                  incomplete documentation is accepted.
                </p>
        ...
        <div className="relative py-20">
          ...
          <div className="relative max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-gray-300 text-lg mb-8">
              ...
              management companies with comprehensive training, career growth,
