...
const EmergencyEscalation = () => {
  ...
  return (
    <>
      <SEO
        title="Cadman Emergency Escalation Matrix – Quick Response & Safety Protocols"
        description="Cadman provides a clear emergency escalation matrix to ensure quick response and safety during incidents. Our structured protocols help businesses and residential communities handle emergencies effectively."
      />
        ...
        <div className="relative h-[560px] w-full">
          ...
          <div className="relative max-w-7xl mx-auto px-6 pt-48 pb-32 lg:pt-56 lg:pb-40 md:pt-44 md:pb-24">
            <div className="max-w-3xl">
              ...
              >
                Our structured escalation system ensures every incident is
                handled with speed, precision, and accountability—from the first
                responder to top management.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Clear classification system for appropriate response and
                resource allocation
              </p>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-white hover:bg-gray-50 transition shadow">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Phone, radio, and digital channels ensure no
                        communication gaps
                      </p>
                    </div>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Immediate identification and assessment of emergency
                  situations
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Rapid deployment of personnel and resources to incident
                  location
                </p>
              </div>
                ...
                <div className="space-y-4">
                  <div className="bg-white p-6 shadow-lg border-l-4 border-amber-500">
                    ...
                    <p className="text-gray-600 text-sm mb-3">
                      Site supervisor documents incident details, location,
                      time, and immediate actions taken
                    </p>
                    <div className="flex flex-wrap gap-2">
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Regular training programs and mock drills ensure every team
                member knows their role in the escalation matrix
              </p>
            </div>
