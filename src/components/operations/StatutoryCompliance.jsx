...
const StatutoryCompliance = () => {
  ...
  return (
    <>
      <SEO
        title="Cadman Statutory Compliance – Legal & Regulatory Adherence"
        description="Cadman ensures all security, facility management, and manpower services comply with statutory regulations and legal requirements, providing businesses and residential communities with safe and lawful operations."
      />
          ...
          <div className="relative max-w-7xl mx-auto px-6 pt-48 pb-32 lg:pt-56 lg:pb-40 md:pt-44 md:pb-24">
            <div className="max-w-3xl">
              ...
              >
                ...
                Government of India. We ensure 100% compliance for every
                employee deployed under our services.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  ...
                  transparency and audit readiness. All documents provided on
                  time for client review.
                </p>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Complete registration under ESI, EPFO, and all statutory
                  bodies
                </p>
              </div>
