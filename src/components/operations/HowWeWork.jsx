...
const HowWeWork = () => {
  ...
  return (
    <>
      <SEO
        title="Cadman Operations – How We Work"
        description="Discover how Cadman delivers professional security, facility management, and manpower services. Our structured operations ensure reliability, efficiency, and high-quality service for businesses and residential communities."
      />
          ...
          <div className="relative max-w-7xl mx-auto px-6 pt-48 pb-32 lg:pt-56 lg:pb-40 md:pt-44 md:pb-24">
            <div className="max-w-3xl">
              ...
              >
                ...
                improvement. Experience seamless service delivery across
                Security, Facility Management, MEP, Soft Services, Pest Control,
                and Fire & Safety.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  ...
                  ensure transparency, and provide real-time visibility across
                  all operations.
                </p>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 hover:bg-amber-50 transition">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        HRMS attendance system with digital daily activity
                        reports
                      </p>
                    </div>
                  </div>
