...
<div className="border-t border-gray-800">
  <div className="max-w-7xl mx-auto px-6 py-6">
    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
      ...
      <a 
        href="https://prktechindia.com/" 
        target="_blank" 
        rel="noopener noreferrer"
        className="text-gray-400 text-sm text-center md:text-right hover:text-gray-300 transition-colors flex items-center gap-1.5"
      >
        Sited by:
         <span className="text-gray-300">PRK Tech</span>
        <svg 
