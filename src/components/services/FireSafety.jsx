...
const FireSafety = () => {
  ...
  return (
    <>
      <SEO
        title="Cadman Fire & Safety Services – Protection & Compliance Solutions"
        description="Cadman provides professional fire and safety services, including fire extinguisher maintenance, safety audits, and emergency preparedness solutions for commercial, industrial, and residential facilities."
      />
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Certified fire safety professionals including guards,
                supervisors, technicians, and emergency response teams for
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-300 mb-8 leading-relaxed">
                  ...
                  incidents, evacuations, and emergency situations with
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-800 hover:bg-gray-750 transition">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Continuous communication channels for immediate alert
                        and coordination
                      </p>
                    </div>
                  </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Comprehensive fire safety solutions across commercial,
                industrial, residential, and hospitality sectors
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                A systematic approach ensuring complete fire safety compliance
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Installation and configuration of fire detection and
                  suppression systems
                </p>
              </div>
        ...
        <div className="relative py-20">
          ...
          <div className="relative max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-gray-300 text-lg mb-8">
              ...
              advanced systems, emergency response teams, and complete
              regulatory compliance.
            </p>
