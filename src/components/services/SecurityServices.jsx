...
const SecurityServices = () => {
  ...
  return (
    <>
      <SEO
        title="Cadman Services – Security, Manpower & Facility Management"
        description="Cadman provides comprehensive services including professional security guards, industrial manpower, housekeeping, and complete facility management solutions tailored for businesses and residential complexes."
      />
        ...
        <div className="relative h-[560px] w-full">
          ...
          <div className="relative max-w-7xl mx-auto px-6 pt-48 pb-32 lg:pt-56 lg:pb-40 md:pt-44 md:pb-24">
            <div className="max-w-3xl">
              ...
              >
                Industry-leading security solutions backed by ISO
                certifications, ex-military expertise, and 10,000+ trained
                professionals operating 24/7.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Advanced access control systems ensuring authorized entry
                  while maintaining seamless operations and comprehensive
                  visitor tracking.
                </p>
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Professional investigation services backed by ex-BSF
                intelligence expertise and advanced surveillance capabilities
              </p>
            </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Comprehensive security management with centralized command
                center operations and complete compliance protocols
              </p>
            </div>
            ...
            <div className="bg-amber-50 p-8 border-l-4 border-amber-500">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  Equipped with advanced surveillance systems, real-time
                  incident tracking, and emergency communication protocols, our
                  control room ensures seamless security operations across all
                  deployment sites.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Integrated crisis management support enables immediate
                  response to any security situation, with direct communication
                  channels to local authorities and emergency services.
                </p>
              </div>
            </div>
          </div>
