...
const FacilityManagement = () => {
  ...
  return (
    <>
      <SEO
        title="Cadman Facility Management – Professional Services for Businesses & Residentials"
        description="Cadman offers reliable facility management services including housekeeping, maintenance, and operational support for businesses, industries, and residential communities, ensuring smooth and safe operations."
      />
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Expert services for waste management, landscaping, and
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Cadman's IFM model ensures cost control, quality improvement,
                and seamless coordination across all services
              </p>
            </div>
            ...
            <div className="bg-amber-50 p-8 border-l-4 border-amber-500">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  unified approach eliminates the complexity of managing
                  multiple vendors, reduces administrative overhead, and ensures
