...
const CCTVSecurity = () => {
  ...
  return (
    <>
      <SEO
        title="Cadman CCTV & Electronic Security Services – Advanced Protection Solutions"
        description="Cadman offers professional CCTV installation, electronic surveillance, and security system services for businesses, industries, and residential complexes, ensuring safety and round-the-clock monitoring."
      />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  ...
                  AI-powered analytics, cloud storage, and mobile integration
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 hover:bg-amber-50 transition">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Flexible storage options with cloud backup and
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gray-50 hover:bg-amber-50 transition">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Intelligent alerts with facial recognition and
                        behavioral analysis
                      </p>
                    </div>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Professional installation by certified technicians with
                  minimal disruption
                </p>
              </div>
